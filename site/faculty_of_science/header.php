...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./resources/css/faculty_of_science.css" />
			    ...
			    <div class="container-fluid">
					...
					<div class="collapse navbar-collapse navbar-right" id="ournav">
						...
						<ul class="nav navbar-nav">
                                                    <li class="active"><a href="faculty_of_science.php"> <?=getLang('FAOFSCI')?> <span class="sr-only"></span></a></li>
                                                    <li><?php if (!isset($_GET['arabic'])) { ?>
                                                            <a  href="?arabic">عربى<span class="sr-only"></span></a>
                                                    </li>
                                                            <?php }  else { ?>
                                                            <a  href="?">English<span class="sr-only"></span></a>
                                                    </li>
                                                            <?php } ?>
